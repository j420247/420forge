...
## Stack - helper methods
    ...
    def spindown_to_zero_appnodes(self):
        ...
        self.state.logaction(INFO, f'Update stack result: {str(update_stack)}')
    ...
    def spinup_to_one_appnode(self):
        ...
        elif 'preupgrade_confluence_version' in self.state.forgestate:
...
## Stack - Major Action Methods
    ...
    def upgrade(self, new_version):
        ...
        elif 'syncnodemin' in self.state.forgestate.keys() and self.state.forgestate['syncnodemin'] != "1":
            self.spinup_remaining_nodes()
    ...
    def destroy(self):
        ...
        try:
            ...
            if "does not exist" in error_message:
                ...
                self.state.logaction(ERROR, f'Error getting stack to destroy: {error_message}')
                return
