...
api.add_resource(DoRollingRestart, '/dorollingrestart/<region>/<stack_name>/<drain>/<threads>/<heaps>')
api.add_resource(DoRestartNode, '/dorestartnode/<region>/<stack_name>/<node>/<drain>/<threads>/<heaps>')
api.add_resource(DoToggleNode, '/dotogglenode/<region>/<stack_name>/<node>/<threads>/<heaps>')
...
api.add_resource(GetStackInfo, '/getStackInfo/<region>/<stack_name>')
...
api.add_resource(GetNodeCPU, '/getNodeCPU/<region>/<stack_name>/<node>')
