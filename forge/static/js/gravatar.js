...
function get_avatar(email, size, url) {
    ...
    if (email.substring(email.lastIndexOf("@") +1) === 'atlassian.com') {
        return url + email.substring(0, email.lastIndexOf("@")) + '?size=Small'
    }

    // If not atlassian user return gravatar as default image src
    return url + MD5(email) + '.jpg?s=' + size;
}
...
$(document).ready(function() {
    $("#avatar-small").attr("src", function() {
        ...
        sessionStorage.setItem("avatar", get_avatar(UserEmail, 200, AvatarUrl));
