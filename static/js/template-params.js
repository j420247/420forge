...
function getTemplateParams(template) {
    ...
    send_http_get_request(baseUrl + "/templateParams/" + repo + "/" + template_name, displayTemplateParams);
}
...
function selectTemplateForStack(stackToRetrieve, templateName) {
    ...
    send_http_get_request(baseUrl  + "/stackParams/" + region + "/" + stackToRetrieve + "/" + templateName, displayStackParams);
}
...
function getSubnets(vpc, updateList) {
    ...
    if (vpc !== "")
        send_http_get_request(baseUrl + "/getSubnetsForVpc/" + subnets_region + "/" + vpc, displaySubnets, functionParams);
    else
        send_http_get_request(baseUrl + "/getAllSubnetsForRegion/" + subnets_region, displaySubnets, functionParams);
}
